...
Add text boxes (numericInput) to specify the x limits of the histogram, as below (5 marks). Also: modify the title and axis labels of the histogram to be correct (1 mark).
...
![Population 2016](D:/Simon Fraser University\2021 spring\STAT 240\Assignments\Lab07\Q1_1.png)

![Population 2011](D:/Simon Fraser University\2021 spring\STAT 240\Assignments\Lab07\Q1_2.png)
